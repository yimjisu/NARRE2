...
class DataLoader():
    ...
    def __init__(self, args):
        ...
        self.train_validation_file_path = os.path.join(args.root_path, args.input_data_type, 'train_validation_ided_whole_data'+self.file_name)
        ...
        self.id_user_dict = pickle.load(open(self.id_user_dict_path, 'rb'),encoding='latin1')
        self.id_item_dict = pickle.load(open(self.id_item_dict_path, 'rb'),encoding='latin1')                                                                                                                              
        self.id_word_dict = pickle.load(open(self.id_word_dict_path, 'rb'),encoding='latin1')
        self.item_reviews_dict = pickle.load(open(self.item_reviews_path, 'rb'),encoding='latin1')
        self.item_real_reviews_dict = pickle.load(open(self.item_real_reviews_path, 'rb'),encoding='latin1')
